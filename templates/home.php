    ...
    <!--<section class="content">
     ...
     <section class="sec">
        <div class="Products">
            ...
            <!-- card start -->
            <div class="card">
                <div class="img"><img src="imgs/ração.png" alt=""></div>
            ...
            <!-- card start -->
            <div class="card">
                <div class="img"><img src="imgs/ração02.png" alt=""></div>
                <div class="desc">Ração</div>
            ...
            <!-- card start -->
            <div class="card">
                <div class="img"><img src="imgs/gato-mix.png" alt=""></div>
                <div class="desc">Ração</div>
            ...
            <!-- card start -->
            <div class="card">
                <div class="img"><img src="imgs/briquedo01.png" alt=""></div>
            ...
            <!-- card start -->
            <div class="card">
                <div class="img"><img src="imgs/brinquedos-pet.png" alt=""></div>
                <div class="desc">Brinquedos</div>
            ...
            <!-- card end -->
             ...
             <!-- card start -->
             <div class="card">
                <div class="img"><img src="imgs/briquedo02.png" alt=""></div>
                <div class="desc">Brinquedos</div>
            ...
            <!-- card end -->
             ...
             <!-- card start -->
             <div class="card">
                <div class="img"><img src="imgs/roupa01.png" alt=""></div>
            ...
            <!-- card end -->
             ...
             <!-- card start -->
             <div class="card">
                <div class="img"><img src="imgs/roupafla.png" alt=""></div>
                <div class="desc">Roupas</div>
            ...
            <!-- card end -->
             ...
             <!-- card start -->
             <div class="card">
                <div class="img"><img src="imgs/naruto-fofo.png" alt=""></div>
                <div class="desc">Roupas</div>
